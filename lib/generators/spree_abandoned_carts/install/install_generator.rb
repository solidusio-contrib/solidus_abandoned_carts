module SpreeAbandonedCarts
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_javascripts
        # append_file 'vendor/assets/javascripts/spree/frontend/all.js', "//= require spree/frontend/spree_abandoned_carts\n"
        # append_file 'vendor/assets/javascripts/spree/backend/all.js', "//= require spree/backend/spree_abandoned_carts\n"
      end
      ...
      def add_migrations
        run 'bundle exec rake railties:install:migrations FROM=spree_abandoned_carts'
      end
